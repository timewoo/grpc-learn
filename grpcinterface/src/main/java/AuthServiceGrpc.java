...
public final class AuthServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<AuthServiceOuterClass.LoginReq,
      AuthServiceOuterClass.Token> getLoginMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "login",
      requestType = AuthServiceOuterClass.LoginReq.class,
      responseType = AuthServiceOuterClass.Token.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<AuthServiceOuterClass.LoginReq,
      AuthServiceOuterClass.Token> getLoginMethod() {
    io.grpc.MethodDescriptor<AuthServiceOuterClass.LoginReq, AuthServiceOuterClass.Token> getLoginMethod;
    if ((getLoginMethod = AuthServiceGrpc.getLoginMethod) == null) {
      synchronized (AuthServiceGrpc.class) {
        if ((getLoginMethod = AuthServiceGrpc.getLoginMethod) == null) {
          AuthServiceGrpc.getLoginMethod = getLoginMethod =
              io.grpc.MethodDescriptor.<AuthServiceOuterClass.LoginReq, AuthServiceOuterClass.Token>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "login"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  AuthServiceOuterClass.LoginReq.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  AuthServiceOuterClass.Token.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<AuthServiceOuterClass.RefreshTokenReq,
      AuthServiceOuterClass.Token> getRefreshTokenMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "refreshToken",
      requestType = AuthServiceOuterClass.RefreshTokenReq.class,
      responseType = AuthServiceOuterClass.Token.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<AuthServiceOuterClass.RefreshTokenReq,
      AuthServiceOuterClass.Token> getRefreshTokenMethod() {
    io.grpc.MethodDescriptor<AuthServiceOuterClass.RefreshTokenReq, AuthServiceOuterClass.Token> getRefreshTokenMethod;
      ...
      synchronized (AuthServiceGrpc.class) {
        if ((getRefreshTokenMethod = AuthServiceGrpc.getRefreshTokenMethod) == null) {
          AuthServiceGrpc.getRefreshTokenMethod = getRefreshTokenMethod =
              io.grpc.MethodDescriptor.<AuthServiceOuterClass.RefreshTokenReq, AuthServiceOuterClass.Token>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "refreshToken"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  AuthServiceOuterClass.RefreshTokenReq.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  AuthServiceOuterClass.Token.getDefaultInstance()))
  ...
  public static abstract class AuthServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void login(AuthServiceOuterClass.LoginReq request,
        io.grpc.stub.StreamObserver<AuthServiceOuterClass.Token> responseObserver) {
     ...
     * </pre>
     */
    public void refreshToken(AuthServiceOuterClass.RefreshTokenReq request,
        io.grpc.stub.StreamObserver<AuthServiceOuterClass.Token> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          ...
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                AuthServiceOuterClass.LoginReq,
                AuthServiceOuterClass.Token>(
                  this, METHODID_LOGIN)))
          .addMethod(
            getRefreshTokenMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                AuthServiceOuterClass.RefreshTokenReq,
                AuthServiceOuterClass.Token>(
  ...
  public static final class AuthServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<AuthServiceBlockingStub> {
     ...
     * </pre>
     */
    public AuthServiceOuterClass.Token login(AuthServiceOuterClass.LoginReq request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
     ...
     * </pre>
     */
    public AuthServiceOuterClass.Token refreshToken(AuthServiceOuterClass.RefreshTokenReq request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class AuthServiceFutureStub extends io.grpc.stub.AbstractFutureStub<AuthServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<AuthServiceOuterClass.Token> login(
        AuthServiceOuterClass.LoginReq request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<AuthServiceOuterClass.Token> refreshToken(
        AuthServiceOuterClass.RefreshTokenReq request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SEND_VERIFICATION_CODE:
          ...
          break;
        case METHODID_LOGIN:
          serviceImpl.login((AuthServiceOuterClass.LoginReq) request,
              (io.grpc.stub.StreamObserver<AuthServiceOuterClass.Token>) responseObserver);
          break;
        case METHODID_REFRESH_TOKEN:
          serviceImpl.refreshToken((AuthServiceOuterClass.RefreshTokenReq) request,
              (io.grpc.stub.StreamObserver<AuthServiceOuterClass.Token>) responseObserver);
          break;
        default:
