...
public final class AppServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<AppServiceOuterClass.UploadAppOrImgReq,
      com.google.protobuf.StringValue> getUploadAppOrImgMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "uploadAppOrImg",
      requestType = AppServiceOuterClass.UploadAppOrImgReq.class,
      responseType = com.google.protobuf.StringValue.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<AppServiceOuterClass.UploadAppOrImgReq,
      com.google.protobuf.StringValue> getUploadAppOrImgMethod() {
    io.grpc.MethodDescriptor<AppServiceOuterClass.UploadAppOrImgReq, com.google.protobuf.StringValue> getUploadAppOrImgMethod;
      ...
      synchronized (AppServiceGrpc.class) {
        if ((getUploadAppOrImgMethod = AppServiceGrpc.getUploadAppOrImgMethod) == null) {
          AppServiceGrpc.getUploadAppOrImgMethod = getUploadAppOrImgMethod =
              io.grpc.MethodDescriptor.<AppServiceOuterClass.UploadAppOrImgReq, com.google.protobuf.StringValue>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "uploadAppOrImg"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  AppServiceOuterClass.UploadAppOrImgReq.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<AppServiceOuterClass.GetAppInfoReq,
      AppServiceOuterClass.AppInfo> getGetAppInfoMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "getAppInfo",
      requestType = AppServiceOuterClass.GetAppInfoReq.class,
      responseType = AppServiceOuterClass.AppInfo.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<AppServiceOuterClass.GetAppInfoReq,
      AppServiceOuterClass.AppInfo> getGetAppInfoMethod() {
    io.grpc.MethodDescriptor<AppServiceOuterClass.GetAppInfoReq, AppServiceOuterClass.AppInfo> getGetAppInfoMethod;
    if ((getGetAppInfoMethod = AppServiceGrpc.getGetAppInfoMethod) == null) {
      synchronized (AppServiceGrpc.class) {
        if ((getGetAppInfoMethod = AppServiceGrpc.getGetAppInfoMethod) == null) {
          AppServiceGrpc.getGetAppInfoMethod = getGetAppInfoMethod =
              io.grpc.MethodDescriptor.<AppServiceOuterClass.GetAppInfoReq, AppServiceOuterClass.AppInfo>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "getAppInfo"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  AppServiceOuterClass.GetAppInfoReq.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  AppServiceOuterClass.AppInfo.getDefaultInstance()))
  ...
  public static abstract class AppServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void uploadAppOrImg(AppServiceOuterClass.UploadAppOrImgReq request,
     ...
     * </pre>
     */
    public void getAppInfo(AppServiceOuterClass.GetAppInfoReq request,
                           io.grpc.stub.StreamObserver<AppServiceOuterClass.AppInfo> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                AppServiceOuterClass.UploadAppOrImgReq,
          ...
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                AppServiceOuterClass.GetAppInfoReq,
                AppServiceOuterClass.AppInfo>(
  ...
  public static final class AppServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<AppServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.protobuf.StringValue uploadAppOrImg(AppServiceOuterClass.UploadAppOrImgReq request) {
     ...
     * </pre>
     */
    public AppServiceOuterClass.AppInfo getAppInfo(AppServiceOuterClass.GetAppInfoReq request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class AppServiceFutureStub extends io.grpc.stub.AbstractFutureStub<AppServiceFutureStub> {
    ...
    public com.google.common.util.concurrent.ListenableFuture<com.google.protobuf.StringValue> uploadAppOrImg(
        AppServiceOuterClass.UploadAppOrImgReq request) {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<AppServiceOuterClass.AppInfo> getAppInfo(
        AppServiceOuterClass.GetAppInfoReq request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_UPLOAD_APP_OR_IMG:
          serviceImpl.uploadAppOrImg((AppServiceOuterClass.UploadAppOrImgReq) request,
              (io.grpc.stub.StreamObserver<com.google.protobuf.StringValue>) responseObserver);
          break;
        case METHODID_GET_APP_INFO:
          serviceImpl.getAppInfo((AppServiceOuterClass.GetAppInfoReq) request,
              (io.grpc.stub.StreamObserver<AppServiceOuterClass.AppInfo>) responseObserver);
          break;
        default:
